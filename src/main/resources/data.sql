...
INSERT INTO member_subscription (
  member_id, gym_id, date_from, date_to, paid_amount,
  receipt_number, num_of_sessions,
  created_by, created_on
) VALUES
(1, 1, DATE_SUB(CURDATE(), INTERVAL 60 DAY), DATE_ADD(CURDATE(), INTERVAL 30 DAY), 600, 'RCPT-2001', 30, 1, NOW()),
(2, 1, DATE_SUB(CURDATE(), INTERVAL 40 DAY), DATE_SUB(CURDATE(), INTERVAL 10 DAY), 500, 'RCPT-2002', 20, 1, NOW()),
(3, 1, DATE_SUB(CURDATE(), INTERVAL 60 DAY), DATE_ADD(CURDATE(), INTERVAL 90 DAY), 1500, 'RCPT-2003', 90, 1, NOW()),
(4, 2, DATE_SUB(CURDATE(), INTERVAL 60 DAY), DATE_ADD(CURDATE(), INTERVAL 30 DAY), 700, 'RCPT-3001', 30, 1, NOW()),
(5, 3, DATE_SUB(CURDATE(), INTERVAL 60 DAY), DATE_ADD(CURDATE(), INTERVAL 15 DAY), 650, 'RCPT-3002', 30, 1, NOW()),
(6, 1, DATE_SUB(CURDATE(), INTERVAL 60 DAY), DATE_ADD(CURDATE(), INTERVAL 30 DAY), 550, 'RCPT-4001', 25, 1, NOW());
